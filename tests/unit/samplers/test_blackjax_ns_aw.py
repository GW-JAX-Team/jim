"""Smoke test: BlackJAXNSAWSampler on a 2-D Gaussian (analytic logZ = 0)."""
...
def test_ns_aw_log_evidence_reasonable():
    """log Z for a normalised Gaussian should be close to log(2π σ²)."""

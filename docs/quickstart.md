...
For a full worked example, see the [Getting Started tutorial](tutorials/getting_started.ipynb). For production-grade scripts, browse the [`example/` directory on GitHub](https://github.com/kazewong/jim/tree/main/example).

...
- **[Getting Started](getting_started)** — A minimal end-to-end example: inject a signal and sample two parameters.
...
- **[Samplers](samplers.md)** — flowMC, BlackJAX NS-AW, NSS, and SMC; installation, config reference, periodic parameters, and how to write your own sampler.
